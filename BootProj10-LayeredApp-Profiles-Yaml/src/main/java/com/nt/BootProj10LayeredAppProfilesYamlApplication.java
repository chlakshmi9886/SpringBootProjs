...
public class BootProj10LayeredAppProfilesYamlApplication {
	...
	public static void main(String[] args) {
		ApplicationContext ctx = SpringApplication.run(BootProj10LayeredAppProfilesYamlApplication.class, args);
