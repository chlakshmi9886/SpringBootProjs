...
public class BootProj11LayeredAppProfilesSingleYamlFileApplication {
	...
	public static void main(String[] args) {
		ApplicationContext ctx = SpringApplication.run(BootProj11LayeredAppProfilesSingleYamlFileApplication.class, args);
